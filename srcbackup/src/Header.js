...
class Header extends Component {
	...
	render(){
		var serachlist =this.state.results.map((value, index) => (
	        <li key={value.FINCODE}><Link to="" onClick={() => this.onClickSearchHadler(value.FINCODE)}>{value.compname}</Link></li>
      	));
		return	<header>
					          ...
					          <div className="headerSearch">
					            <form>
					            	<div className="searchDiv mt00">
						              ...
						              <input type="text" name="query" id="query" placeholder="Search Stock" value={this.state.query}  onChange={this.onChangeHadler.bind(this)}/>
					    ...
					    <nav id="gNavi">
					        <ul className="clearfix">
					          ...
					          <li className="userImg">
					            <Link to="#" className="navbarToggle" data-target=".userDrop">
